...
$params = '{
   ...
   "type": 2,
   "subject": "Retornar contato comercial para o número '."$origem".'",
   "status": "Novo",
...
$idd = "&id=$id";
$url = "https://api.movidesk.com/public/v1/ticketFileUpload?token=qwerty&actionId=1";
$ch = curl_init("$url");
...
#Hangup Client
$agradecimento = $agi->stream_file("/var/lib/asterisk/sounds/ura/union/consultor_ocupado");
$hangup = $agi->hangup();
